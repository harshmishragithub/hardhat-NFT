...
contract DynamicSvgNft is ERC721, Ownable {
    ...
    function svgToImageURI(string memory svg) public pure returns (string memory) {
        ...
        return string(abi.encodePacked(baseURL, svgBase64Encoded)); // combining two strings encoding them
        // to there bytes implementation and then type casting them in from bytes to string...
    }
